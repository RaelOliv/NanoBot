...
await salvarCache(balance, 'Balance');
  ...
  // ---- GATILHOS DE STOP ----
  if (
    parseFloat(perc) <= parseFloat(-5.0) || parseFloat(perc) >= parseFloat(2.5 ) || parseFloat(perc) >= parseFloat(90.0) // || parseFloat(percReal) >= parseFloat(1.0)  
