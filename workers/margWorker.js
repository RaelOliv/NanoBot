...
await salvarCache(balance, 'Balance');
  ...
  // ---- GATILHOS DE STOP ----
  if (
    parseFloat(perc) <= parseFloat(-25.0) || parseFloat(perc) >= parseFloat(50.0 ) || parseFloat(perc) >= parseFloat(90.0) // || parseFloat(percReal) >= parseFloat(1.0)  
