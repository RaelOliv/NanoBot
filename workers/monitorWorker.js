...
let ema1m250p = undefined;
let ema1m250p_2 = undefined;
...
async function carregarCandlesHistoricos() {
  ...
  try {
    ...
    ema1m250p = calcularEMA(250, candles1m);
...
*/
        ...
        //parseFloat(candles5m.slice(-2)[0].low) <= parseFloat(candles5m.slice(-1)[0].low) &&
        /*
        ...
        */
        ...
        //parseFloat(sRsiLast1h.k) >= parseFloat(sRsiLast1h_2.k) &&
        //parseFloat(sRsiLast1h.d) >= parseFloat(sRsiLast1h_2.d) &&
...
/*
        ...
        parseFloat(sRsiLast30m.k) <= parseFloat(20.0) &&
        parseFloat(sRsiLast15m.k) >= parseFloat(50.0) &&
        parseFloat(sRsiLast15m_2.k) <= parseFloat(50.0) &&
        ...
        //parseFloat(sRsiLast5m.d) <= parseFloat(20.0) &&
        //parseFloat(sRsiLast5m.k) >= parseFloat(20.0) &&

        parseFloat(sRsiLast1m.k) >= parseFloat(sRsiLast1m_2.k) &&
        parseFloat(sRsiLast1m.d) >= parseFloat(sRsiLast1m_2.d) &&
/*
        parseFloat(sRsiLast3m_2.k) <= parseFloat(10.0) &&
        parseFloat(sRsiLast3m.k) >= parseFloat(10.0) &&
*/
      /*
        parseFloat(sRsiLast1h.k) >= parseFloat(sRsiLast1h.d) &&
        ...
        parseFloat(sRsiLast3m.k) >= parseFloat(sRsiLast3m_2.k) &&
        parseFloat(sRsiLast3m.k) >= parseFloat(sRsiLast3m_2.d)
...
*/
    /*
      ...
      (
        ...
        &&
        parseFloat(candles1m.slice(-2)[0].low) <= parseFloat(ema3m400p) //5m9p
        &&
...
/*
        ...
        parseFloat(sRsiLast30m.k) >= parseFloat(80) &&
        parseFloat(sRsiLast15m.k) <= parseFloat(80.0) &&
        parseFloat(sRsiLast15m_2.k) >= parseFloat(80.0) &&
     ...
     parseFloat(sRsiLast1m.k) <= parseFloat(sRsiLast1m_2.k) &&
        parseFloat(sRsiLast1m.d) <= parseFloat(sRsiLast1m_2.d) &&
/*
        parseFloat(sRsiLast3m_2.k) >= parseFloat(90.0) &&
        parseFloat(sRsiLast3m.K) <= parseFloat(90.0) &&
    */    
/*
...
*/
      ...
      */
       ...
       (
        ...
        parseFloat(candles1m.slice(-2)[0].close)
        &&
        parseFloat(candles1m.slice(-2)[0].high) >= parseFloat(ema3m400p)
        &&
